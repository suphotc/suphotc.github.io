let githubUser = 'suphotc'
let repo = 'suphotc.github.io'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbydqGY8qU6PSXldwd3RhB1ydpI9q8vY3Zni8ha9CXCdjrjQQslUAv16eBJHNI9v24b4YA/exec');
